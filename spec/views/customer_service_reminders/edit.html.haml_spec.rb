...
describe "customer_service_reminders/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit customer_service_reminder form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => customer_service_reminders_path(@customer_service_reminder), :method => "post" do
